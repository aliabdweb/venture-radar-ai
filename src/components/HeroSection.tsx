...
const HeroSection = () => {
  return (
    <section className="relative py-20 md:py-32 px-4 overflow-hidden hero-pattern">
      {/* Purple gradient shapes */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-venture-purple/10 rounded-full blur-[100px] -z-10"></div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start animate-fade-in" style={{ animationDelay: "0.3s" }}>
              <Button className="bg-venture-purple hover:bg-venture-purple-dark text-white text-lg px-8 py-6 h-auto">
                Get Started
              </Button>
              <Button variant="outline" className="border-venture-purple text-venture-purple hover:bg-venture-purple hover:text-white group flex items-center gap-2 text-lg px-8 py-6 h-auto">
                Watch Demo
            ...
            <div className="mt-10 flex items-center justify-center md:justify-start gap-4 animate-fade-in" style={{ animationDelay: "0.4s" }}>
              ...
              <p className="text-sm text-venture-gray">Trusted by <span className="font-bold">500+</span> companies</p>
            </div>
          </div>
          
          {/* Hero Image */}
          <div className="w-full md:w-1/2 animate-fade-in-slow">
            <div className="relative bg-white rounded-lg shadow-xl p-4 md:p-6 gradient-border">
              ...
              {/* Dashboard elements */}
              <div className="absolute top-12 right-12 w-1/3 h-24 bg-white shadow-lg rounded-lg p-3 animate-float">
                <div className="flex items-center justify-between mb-2">
                  <div className="w-8 h-8 rounded-full bg-venture-purple/20"></div>
              ...
              <div className="absolute bottom-10 left-14 w-1/4 h-20 bg-white shadow-lg rounded-lg p-3" style={{ animationDelay: "1s" }}>
                <div className="w-6 h-6 rounded-full bg-venture-purple mb-2"></div>
